...
@override
String toString() {
  return 'GroupCycle(cycleId: $cycleId, cycleNumber: $cycleNumber, topic: $topic, starterUserId: $starterUserId, status: $status, startedAt: $startedAt, deadlineAt: $deadlineAt)';
}
...
class _GroupCycle implements GroupCycle {
  const _GroupCycle({required this.cycleId, required this.cycleNumber, required this.topic, required this.starterUserId, required this.status, required this.startedAt, required this.deadlineAt});
