...
class AppText extends StatelessWidget {
  ...
  const AppText.display(this.text, {super.key, this.textAlign, this.color})
  ...
  const AppText.label(this.text, {super.key, this.textAlign, this.color})
  ...
  const AppText.caption(this.text, {super.key, this.textAlign, this.color})
