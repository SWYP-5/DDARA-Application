...
mixin _$GroupResponse {
 ...
 int get groupId; String get name; String get ownerNickname; int get memberCount;// 진행 중인 사이클이 없으면 null.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,groupId,name,ownerNickname,memberCount,currentCycle,createdAt);

@override
String toString() {
  return 'GroupResponse(groupId: $groupId, name: $name, ownerNickname: $ownerNickname, memberCount: $memberCount, currentCycle: $currentCycle, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int groupId, String name, String ownerNickname, int memberCount, CurrentCycleResponse? currentCycle, DateTime createdAt
});
...
/// Create a copy of GroupResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? groupId = null,Object? name = null,Object? ownerNickname = null,Object? memberCount = null,Object? currentCycle = freezed,Object? createdAt = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int groupId,  String name,  String ownerNickname,  int memberCount,  CurrentCycleResponse? currentCycle,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupResponse() when $default != null:
return $default(_that.groupId,_that.name,_that.ownerNickname,_that.memberCount,_that.currentCycle,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int groupId,  String name,  String ownerNickname,  int memberCount,  CurrentCycleResponse? currentCycle,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _GroupResponse():
return $default(_that.groupId,_that.name,_that.ownerNickname,_that.memberCount,_that.currentCycle,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int groupId,  String name,  String ownerNickname,  int memberCount,  CurrentCycleResponse? currentCycle,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _GroupResponse() when $default != null:
return $default(_that.groupId,_that.name,_that.ownerNickname,_that.memberCount,_that.currentCycle,_that.createdAt);case _:
  return null;
...
class _GroupResponse implements GroupResponse {
  const _GroupResponse({required this.groupId, required this.name, required this.ownerNickname, required this.memberCount, required this.currentCycle, required this.createdAt});
...
/// Create a copy of GroupResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? groupId = null,Object? name = null,Object? ownerNickname = null,Object? memberCount = null,Object? currentCycle = freezed,Object? createdAt = null,}) {
...
mixin _$CurrentCycleResponse {
 ...
 int get cycleId; String get topic; String get status; DateTime get startedAt; String? get thumbnailUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,cycleId,topic,status,startedAt,thumbnailUrl);

@override
String toString() {
  return 'CurrentCycleResponse(cycleId: $cycleId, topic: $topic, status: $status, startedAt: $startedAt, thumbnailUrl: $thumbnailUrl)';
}
...
@useResult
$Res call({
 int cycleId, String topic, String status, DateTime startedAt, String? thumbnailUrl
});
...
/// Create a copy of CurrentCycleResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cycleId = null,Object? topic = null,Object? status = null,Object? startedAt = null,Object? thumbnailUrl = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int cycleId,  String topic,  String status,  DateTime startedAt,  String? thumbnailUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CurrentCycleResponse() when $default != null:
return $default(_that.cycleId,_that.topic,_that.status,_that.startedAt,_that.thumbnailUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int cycleId,  String topic,  String status,  DateTime startedAt,  String? thumbnailUrl)  $default,) {final _that = this;
switch (_that) {
case _CurrentCycleResponse():
return $default(_that.cycleId,_that.topic,_that.status,_that.startedAt,_that.thumbnailUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int cycleId,  String topic,  String status,  DateTime startedAt,  String? thumbnailUrl)?  $default,) {final _that = this;
switch (_that) {
case _CurrentCycleResponse() when $default != null:
return $default(_that.cycleId,_that.topic,_that.status,_that.startedAt,_that.thumbnailUrl);case _:
  return null;
...
class _CurrentCycleResponse implements CurrentCycleResponse {
  const _CurrentCycleResponse({required this.cycleId, required this.topic, required this.status, required this.startedAt, required this.thumbnailUrl});
...
/// Create a copy of CurrentCycleResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? cycleId = null,Object? topic = null,Object? status = null,Object? startedAt = null,Object? thumbnailUrl = freezed,}) {
